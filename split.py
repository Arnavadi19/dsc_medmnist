splits_2020 = {
    'bloodmnist': [
        # Split 1: 4 known, 4 unknown (original 8 classes only)
    ...
    'octmnist': [
        # Healthy class (0) always included in known
        {'known': [0, 1, 2], 'unknown': [3]},
        {'known': [0, 1, 3], 'unknown': [2]},
        {'known': [0, 2, 3], 'unknown': [1]}
    ],
    'mnist': [
        [2, 4, 5, 9, 8, 3],
        [3, 2, 6, 9, 4, 0],
